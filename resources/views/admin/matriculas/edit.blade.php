...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.matricula.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.matriculas.update", [$matricula->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('ano') ? 'is-invalid' : '' }}" name="ano_id" id="ano_id" required>
                    @foreach($anos as $id => $entry)
                        <option value="{{ $id }}" {{ (old('ano_id') ? old('ano_id') : $matricula->ano->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('ano'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="number" name="status" id="status" value="{{ old('status', $matricula->status) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('aluno') ? 'is-invalid' : '' }}" name="aluno_id" id="aluno_id" required>
                    @foreach($alunos as $id => $entry)
                        <option value="{{ $id }}" {{ (old('aluno_id') ? old('aluno_id') : $matricula->aluno->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('aluno'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('aluno_nome') ? 'is-invalid' : '' }}" type="text" name="aluno_nome" id="aluno_nome" value="{{ old('aluno_nome', $matricula->aluno_nome) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('mae') ? 'is-invalid' : '' }}" name="mae_id" id="mae_id" required>
                    @foreach($maes as $id => $entry)
                        <option value="{{ $id }}" {{ (old('mae_id') ? old('mae_id') : $matricula->mae->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('mae'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mae_nome') ? 'is-invalid' : '' }}" type="text" name="mae_nome" id="mae_nome" value="{{ old('mae_nome', $matricula->mae_nome) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('pai') ? 'is-invalid' : '' }}" name="pai_id" id="pai_id" required>
                    @foreach($pais as $id => $entry)
                        <option value="{{ $id }}" {{ (old('pai_id') ? old('pai_id') : $matricula->pai->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('pai'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pai_nome') ? 'is-invalid' : '' }}" type="text" name="pai_nome" id="pai_nome" value="{{ old('pai_nome', $matricula->pai_nome) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('turno') ? 'is-invalid' : '' }}" type="text" name="turno" id="turno" value="{{ old('turno', $matricula->turno) }}">
                @if($errors->has('turno'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('turma') ? 'is-invalid' : '' }}" name="turma_id" id="turma_id">
                    @foreach($turmas as $id => $entry)
                        <option value="{{ $id }}" {{ (old('turma_id') ? old('turma_id') : $matricula->turma->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('turma'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('turma_nome') ? 'is-invalid' : '' }}" type="text" name="turma_nome" id="turma_nome" value="{{ old('turma_nome', $matricula->turma_nome) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('valor') ? 'is-invalid' : '' }}" type="number" name="valor" id="valor" value="{{ old('valor', $matricula->valor) }}" step="0.01" required>
                @if($errors->has('valor'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('desconto') ? 'is-invalid' : '' }}" type="number" name="desconto" id="desconto" value="{{ old('desconto', $matricula->desconto) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total') ? 'is-invalid' : '' }}" type="number" name="total" id="total" value="{{ old('total', $matricula->total) }}" step="0.01" required>
                @if($errors->has('total'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('conceito_1') ? 'is-invalid' : '' }}" name="conceito_1" id="conceito_1">{{ old('conceito_1', $matricula->conceito_1) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('conceito_2') ? 'is-invalid' : '' }}" name="conceito_2" id="conceito_2">{{ old('conceito_2', $matricula->conceito_2) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('conceito_3') ? 'is-invalid' : '' }}" name="conceito_3" id="conceito_3">{{ old('conceito_3', $matricula->conceito_3) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('conceito_4') ? 'is-invalid' : '' }}" name="conceito_4" id="conceito_4">{{ old('conceito_4', $matricula->conceito_4) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('conceitofinal') ? 'is-invalid' : '' }}" name="conceitofinal" id="conceitofinal">{{ old('conceitofinal', $matricula->conceitofinal) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('obs') ? 'is-invalid' : '' }}" name="obs" id="obs">{{ old('obs', $matricula->obs) }}</textarea>
                @if($errors->has('obs'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('falta_1') ? 'is-invalid' : '' }}" type="number" name="falta_1" id="falta_1" value="{{ old('falta_1', $matricula->falta_1) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('falta_2') ? 'is-invalid' : '' }}" type="number" name="falta_2" id="falta_2" value="{{ old('falta_2', $matricula->falta_2) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('falta_3') ? 'is-invalid' : '' }}" type="number" name="falta_3" id="falta_3" value="{{ old('falta_3', $matricula->falta_3) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('falta_4') ? 'is-invalid' : '' }}" type="number" name="falta_4" id="falta_4" value="{{ old('falta_4', $matricula->falta_4) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('faltaf') ? 'is-invalid' : '' }}" type="number" name="faltaf" id="faltaf" value="{{ old('faltaf', $matricula->faltaf) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('data_transferencia') ? 'is-invalid' : '' }}" type="text" name="data_transferencia" id="data_transferencia" value="{{ old('data_transferencia', $matricula->data_transferencia) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('obs_transferencia') ? 'is-invalid' : '' }}" name="obs_transferencia" id="obs_transferencia">{{ old('obs_transferencia', $matricula->obs_transferencia) }}</textarea>
