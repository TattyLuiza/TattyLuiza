...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.boleto.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.boletos.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('banco') ? 'is-invalid' : '' }}" name="banco_id" id="banco_id" required>
                    @foreach($bancos as $id => $entry)
                        <option value="{{ $id }}" {{ old('banco_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('banco'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('movimento') ? 'is-invalid' : '' }}" type="text" name="movimento" id="movimento" value="{{ old('movimento', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('parcela') ? 'is-invalid' : '' }}" type="text" name="parcela" id="parcela" value="{{ old('parcela', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('recebido') ? 'is-invalid' : '' }}" type="number" name="recebido" id="recebido" value="{{ old('recebido', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('datadesconto') ? 'is-invalid' : '' }}" type="text" name="datadesconto" id="datadesconto" value="{{ old('datadesconto') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('valordesconto') ? 'is-invalid' : '' }}" type="number" name="valordesconto" id="valordesconto" value="{{ old('valordesconto', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('instrucoes') ? 'is-invalid' : '' }}" type="text" name="instrucoes" id="instrucoes" value="{{ old('instrucoes', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tipo') ? 'is-invalid' : '' }}" type="number" name="tipo" id="tipo" value="{{ old('tipo', '') }}" step="1">
                @if($errors->has('tipo'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mora') ? 'is-invalid' : '' }}" type="text" name="mora" id="mora" value="{{ old('mora', '') }}">
                @if($errors->has('mora'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('multa') ? 'is-invalid' : '' }}" type="text" name="multa" id="multa" value="{{ old('multa', '') }}">
                @if($errors->has('multa'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('vencimento') ? 'is-invalid' : '' }}" type="text" name="vencimento" id="vencimento" value="{{ old('vencimento') }}" required>
