...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.banco.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.bancos.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('padrao') ? 'is-invalid' : '' }}" type="number" name="padrao" id="padrao" value="{{ old('padrao', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('listar') ? 'is-invalid' : '' }}" type="number" name="listar" id="listar" value="{{ old('listar', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cod') ? 'is-invalid' : '' }}" type="number" name="cod" id="cod" value="{{ old('cod', '') }}" step="1">
                @if($errors->has('cod'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('beneficiario') ? 'is-invalid' : '' }}" type="text" name="beneficiario" id="beneficiario" value="{{ old('beneficiario', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('taxa') ? 'is-invalid' : '' }}" type="number" name="taxa" id="taxa" value="{{ old('taxa', '') }}" step="0.01">
                @if($errors->has('taxa'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('agencia') ? 'is-invalid' : '' }}" type="number" name="agencia" id="agencia" value="{{ old('agencia', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('agencia_dv') ? 'is-invalid' : '' }}" type="number" name="agencia_dv" id="agencia_dv" value="{{ old('agencia_dv', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('conta') ? 'is-invalid' : '' }}" type="number" name="conta" id="conta" value="{{ old('conta', '') }}" step="1">
                @if($errors->has('conta'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('conta_dv') ? 'is-invalid' : '' }}" type="number" name="conta_dv" id="conta_dv" value="{{ old('conta_dv', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cedente') ? 'is-invalid' : '' }}" type="number" name="cedente" id="cedente" value="{{ old('cedente', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cedente_dv') ? 'is-invalid' : '' }}" type="number" name="cedente_dv" id="cedente_dv" value="{{ old('cedente_dv', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('carteira') ? 'is-invalid' : '' }}" type="number" name="carteira" id="carteira" value="{{ old('carteira', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('arquivo') ? 'is-invalid' : '' }}" type="text" name="arquivo" id="arquivo" value="{{ old('arquivo', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('instrucoes') ? 'is-invalid' : '' }}" name="instrucoes" id="instrucoes">{!! old('instrucoes') !!}</textarea>
