...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.aluno.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.alunos.update", [$aluno->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status" required>
                    ...
                    @foreach(App\Models\Aluno::STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status', $aluno->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nome') ? 'is-invalid' : '' }}" type="text" name="nome" id="nome" value="{{ old('nome', $aluno->nome) }}" required>
                @if($errors->has('nome'))
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('sexo') ? 'is-invalid' : '' }}" name="sexo" id="sexo">
                    ...
                    @foreach(App\Models\Aluno::SEXO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('sexo', $aluno->sexo) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('sexo'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('nascimento') ? 'is-invalid' : '' }}" type="text" name="nascimento" id="nascimento" value="{{ old('nascimento', $aluno->nascimento) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cpf') ? 'is-invalid' : '' }}" type="text" name="cpf" id="cpf" value="{{ old('cpf', $aluno->cpf) }}">
                @if($errors->has('cpf'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rg') ? 'is-invalid' : '' }}" type="text" name="rg" id="rg" value="{{ old('rg', $aluno->rg) }}">
                @if($errors->has('rg'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nacionalidade') ? 'is-invalid' : '' }}" type="text" name="nacionalidade" id="nacionalidade" value="{{ old('nacionalidade', $aluno->nacionalidade) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('naturalidade') ? 'is-invalid' : '' }}" type="text" name="naturalidade" id="naturalidade" value="{{ old('naturalidade', $aluno->naturalidade) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cep') ? 'is-invalid' : '' }}" type="text" name="cep" id="cep" value="{{ old('cep', $aluno->cep) }}">
                @if($errors->has('cep'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rua') ? 'is-invalid' : '' }}" type="text" name="rua" id="rua" value="{{ old('rua', $aluno->rua) }}">
                @if($errors->has('rua'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('numero') ? 'is-invalid' : '' }}" type="text" name="numero" id="numero" value="{{ old('numero', $aluno->numero) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('complemento') ? 'is-invalid' : '' }}" type="text" name="complemento" id="complemento" value="{{ old('complemento', $aluno->complemento) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bairro') ? 'is-invalid' : '' }}" type="text" name="bairro" id="bairro" value="{{ old('bairro', $aluno->bairro) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cidade') ? 'is-invalid' : '' }}" type="text" name="cidade" id="cidade" value="{{ old('cidade', $aluno->cidade) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('estado') ? 'is-invalid' : '' }}" type="text" name="estado" id="estado" value="{{ old('estado', $aluno->estado) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('mae') ? 'is-invalid' : '' }}" name="mae_id" id="mae_id">
                    @foreach($maes as $id => $entry)
                        <option value="{{ $id }}" {{ (old('mae_id') ? old('mae_id') : $aluno->mae->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('mae'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('pai') ? 'is-invalid' : '' }}" name="pai_id" id="pai_id">
                    @foreach($pais as $id => $entry)
                        <option value="{{ $id }}" {{ (old('pai_id') ? old('pai_id') : $aluno->pai->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('pai'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('financeiro') ? 'is-invalid' : '' }}" name="financeiro_id" id="financeiro_id">
                    @foreach($financeiros as $id => $entry)
                        <option value="{{ $id }}" {{ (old('financeiro_id') ? old('financeiro_id') : $aluno->financeiro->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefone') ? 'is-invalid' : '' }}" type="text" name="telefone" id="telefone" value="{{ old('telefone', $aluno->telefone) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('acesso') ? 'is-invalid' : '' }}" type="text" name="acesso" id="acesso" value="{{ old('acesso', $aluno->acesso) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email" id="email" value="{{ old('email', $aluno->email) }}">
                @if($errors->has('email'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('categoria') ? 'is-invalid' : '' }}" type="text" name="categoria" id="categoria" value="{{ old('categoria', $aluno->categoria) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('frequentar') ? 'is-invalid' : '' }}" type="text" name="frequentar" id="frequentar" value="{{ old('frequentar', $aluno->frequentar) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('busca') ? 'is-invalid' : '' }}" type="text" name="busca" id="busca" value="{{ old('busca', $aluno->busca) }}">
                @if($errors->has('busca'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('busca_1') ? 'is-invalid' : '' }}" type="text" name="busca_1" id="busca_1" value="{{ old('busca_1', $aluno->busca_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('busca_2') ? 'is-invalid' : '' }}" type="text" name="busca_2" id="busca_2" value="{{ old('busca_2', $aluno->busca_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('busca_3') ? 'is-invalid' : '' }}" type="text" name="busca_3" id="busca_3" value="{{ old('busca_3', $aluno->busca_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('busca_4') ? 'is-invalid' : '' }}" type="text" name="busca_4" id="busca_4" value="{{ old('busca_4', $aluno->busca_4) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('parentesco_1') ? 'is-invalid' : '' }}" type="text" name="parentesco_1" id="parentesco_1" value="{{ old('parentesco_1', $aluno->parentesco_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('parentesco_2') ? 'is-invalid' : '' }}" type="text" name="parentesco_2" id="parentesco_2" value="{{ old('parentesco_2', $aluno->parentesco_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('parentesco_3') ? 'is-invalid' : '' }}" type="text" name="parentesco_3" id="parentesco_3" value="{{ old('parentesco_3', $aluno->parentesco_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('parentesco_4') ? 'is-invalid' : '' }}" type="text" name="parentesco_4" id="parentesco_4" value="{{ old('parentesco_4', $aluno->parentesco_4) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('desc_1') ? 'is-invalid' : '' }}" type="text" name="desc_1" id="desc_1" value="{{ old('desc_1', $aluno->desc_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('desc_2') ? 'is-invalid' : '' }}" type="text" name="desc_2" id="desc_2" value="{{ old('desc_2', $aluno->desc_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('desc_3') ? 'is-invalid' : '' }}" type="text" name="desc_3" id="desc_3" value="{{ old('desc_3', $aluno->desc_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('desc_4') ? 'is-invalid' : '' }}" type="text" name="desc_4" id="desc_4" value="{{ old('desc_4', $aluno->desc_4) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('desc_5') ? 'is-invalid' : '' }}" type="text" name="desc_5" id="desc_5" value="{{ old('desc_5', $aluno->desc_5) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('diavencimento') ? 'is-invalid' : '' }}" type="number" name="diavencimento" id="diavencimento" value="{{ old('diavencimento', $aluno->diavencimento) }}" step="1">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('alergia') ? 'is-invalid' : '' }}" name="alergia" id="alergia">{{ old('alergia', $aluno->alergia) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('convulsao') ? 'is-invalid' : '' }}" name="convulsao" id="convulsao">{{ old('convulsao', $aluno->convulsao) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('pronto_socorro') ? 'is-invalid' : '' }}" name="pronto_socorro" id="pronto_socorro">{{ old('pronto_socorro', $aluno->pronto_socorro) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('remedio') ? 'is-invalid' : '' }}" name="remedio" id="remedio">{{ old('remedio', $aluno->remedio) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('fala') ? 'is-invalid' : '' }}" name="fala" id="fala">{{ old('fala', $aluno->fala) }}</textarea>
                @if($errors->has('fala'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('audicao') ? 'is-invalid' : '' }}" name="audicao" id="audicao">{{ old('audicao', $aluno->audicao) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('febre') ? 'is-invalid' : '' }}" name="febre" id="febre">{{ old('febre', $aluno->febre) }}</textarea>
                @if($errors->has('febre'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('convenio') ? 'is-invalid' : '' }}" name="convenio" id="convenio">{{ old('convenio', $aluno->convenio) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('recomendacao') ? 'is-invalid' : '' }}" name="recomendacao" id="recomendacao">{{ old('recomendacao', $aluno->recomendacao) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('natacao') ? 'is-invalid' : '' }}" name="natacao" id="natacao">{{ old('natacao', $aluno->natacao) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('obs') ? 'is-invalid' : '' }}" name="obs" id="obs">{{ old('obs', $aluno->obs) }}</textarea>
                @if($errors->has('obs'))
