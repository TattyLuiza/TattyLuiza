...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.turmaprofessordisciplina.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.turmaprofessordisciplinas.store") }}" enctype="multipart/form-data">
            @csrf
