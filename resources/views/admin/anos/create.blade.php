...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.ano.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.anos.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="ano">{{ trans('cruds.ano.fields.ano') }}</label>
                <input class="form-control date {{ $errors->has('ano') ? 'is-invalid' : '' }}" type="text" name="ano" id="ano" value="{{ old('ano') }}" required>
                @if($errors->has('ano'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('logomarca') ? 'is-invalid' : '' }}" type="text" name="logomarca" id="logomarca" value="{{ old('logomarca', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('escola') ? 'is-invalid' : '' }}" type="text" name="escola" id="escola" value="{{ old('escola', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('portaria_1') ? 'is-invalid' : '' }}" type="text" name="portaria_1" id="portaria_1" value="{{ old('portaria_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('portaria_2') ? 'is-invalid' : '' }}" type="text" name="portaria_2" id="portaria_2" value="{{ old('portaria_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('portaria_3') ? 'is-invalid' : '' }}" type="text" name="portaria_3" id="portaria_3" value="{{ old('portaria_3', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('portaria_4') ? 'is-invalid' : '' }}" type="text" name="portaria_4" id="portaria_4" value="{{ old('portaria_4', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('portaria_5') ? 'is-invalid' : '' }}" type="text" name="portaria_5" id="portaria_5" value="{{ old('portaria_5', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('portaria_6') ? 'is-invalid' : '' }}" type="text" name="portaria_6" id="portaria_6" value="{{ old('portaria_6', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefones') ? 'is-invalid' : '' }}" type="text" name="telefones" id="telefones" value="{{ old('telefones', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('boletim') ? 'is-invalid' : '' }}" type="text" name="boletim" id="boletim" value="{{ old('boletim', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('falta') ? 'is-invalid' : '' }}" type="text" name="falta" id="falta" value="{{ old('falta', '') }}">
                @if($errors->has('falta'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bim_1') ? 'is-invalid' : '' }}" type="number" name="bim_1" id="bim_1" value="{{ old('bim_1', '') }}" step="1" required>
                @if($errors->has('bim_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bim_2') ? 'is-invalid' : '' }}" type="number" name="bim_2" id="bim_2" value="{{ old('bim_2', '') }}" step="1" required>
                @if($errors->has('bim_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bim_3') ? 'is-invalid' : '' }}" type="number" name="bim_3" id="bim_3" value="{{ old('bim_3', '') }}" step="1" required>
                @if($errors->has('bim_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bim_4') ? 'is-invalid' : '' }}" type="number" name="bim_4" id="bim_4" value="{{ old('bim_4', '') }}" step="1" required>
                @if($errors->has('bim_4'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('valor_1') ? 'is-invalid' : '' }}" type="number" name="valor_1" id="valor_1" value="{{ old('valor_1', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('valor_2') ? 'is-invalid' : '' }}" type="number" name="valor_2" id="valor_2" value="{{ old('valor_2', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('valor_3') ? 'is-invalid' : '' }}" type="number" name="valor_3" id="valor_3" value="{{ old('valor_3', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('valor_4') ? 'is-invalid' : '' }}" type="number" name="valor_4" id="valor_4" value="{{ old('valor_4', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('valor_5') ? 'is-invalid' : '' }}" type="number" name="valor_5" id="valor_5" value="{{ old('valor_5', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('prof_recado') ? 'is-invalid' : '' }}" type="number" name="prof_recado" id="prof_recado" value="{{ old('prof_recado', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('prof_tarefa') ? 'is-invalid' : '' }}" type="number" name="prof_tarefa" id="prof_tarefa" value="{{ old('prof_tarefa', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('datai_1') ? 'is-invalid' : '' }}" type="text" name="datai_1" id="datai_1" value="{{ old('datai_1') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('dataf_1') ? 'is-invalid' : '' }}" type="text" name="dataf_1" id="dataf_1" value="{{ old('dataf_1') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('datai_2') ? 'is-invalid' : '' }}" type="text" name="datai_2" id="datai_2" value="{{ old('datai_2') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('dataf_2') ? 'is-invalid' : '' }}" type="text" name="dataf_2" id="dataf_2" value="{{ old('dataf_2') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('datai_3') ? 'is-invalid' : '' }}" type="text" name="datai_3" id="datai_3" value="{{ old('datai_3') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('dataf_3') ? 'is-invalid' : '' }}" type="text" name="dataf_3" id="dataf_3" value="{{ old('dataf_3') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('datai_4') ? 'is-invalid' : '' }}" type="text" name="datai_4" id="datai_4" value="{{ old('datai_4') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('dataf_4') ? 'is-invalid' : '' }}" type="text" name="dataf_4" id="dataf_4" value="{{ old('dataf_4') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('diapgto') ? 'is-invalid' : '' }}" type="number" name="diapgto" id="diapgto" value="{{ old('diapgto', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mora_1') ? 'is-invalid' : '' }}" type="text" name="mora_1" id="mora_1" value="{{ old('mora_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('multa_1') ? 'is-invalid' : '' }}" type="text" name="multa_1" id="multa_1" value="{{ old('multa_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('instrucao_1') ? 'is-invalid' : '' }}" type="text" name="instrucao_1" id="instrucao_1" value="{{ old('instrucao_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mora_2') ? 'is-invalid' : '' }}" type="text" name="mora_2" id="mora_2" value="{{ old('mora_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('multa_2') ? 'is-invalid' : '' }}" type="text" name="multa_2" id="multa_2" value="{{ old('multa_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('instrucao_2') ? 'is-invalid' : '' }}" type="text" name="instrucao_2" id="instrucao_2" value="{{ old('instrucao_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mora_3') ? 'is-invalid' : '' }}" type="text" name="mora_3" id="mora_3" value="{{ old('mora_3', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('multa_3') ? 'is-invalid' : '' }}" type="text" name="multa_3" id="multa_3" value="{{ old('multa_3', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('instrucao_3') ? 'is-invalid' : '' }}" type="text" name="instrucao_3" id="instrucao_3" value="{{ old('instrucao_3', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mora_4') ? 'is-invalid' : '' }}" type="text" name="mora_4" id="mora_4" value="{{ old('mora_4', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('multa_4') ? 'is-invalid' : '' }}" type="text" name="multa_4" id="multa_4" value="{{ old('multa_4', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('instrucao_4') ? 'is-invalid' : '' }}" type="text" name="instrucao_4" id="instrucao_4" value="{{ old('instrucao_4', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dia_vencimento') ? 'is-invalid' : '' }}" type="number" name="dia_vencimento" id="dia_vencimento" value="{{ old('dia_vencimento', '') }}" step="1" required>
