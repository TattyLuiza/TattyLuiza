...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.boletin.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.boletins.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('t_1') ? 'is-invalid' : '' }}" type="text" name="t_1" id="t_1" value="{{ old('t_1', '') }}">
                @if($errors->has('t_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('n_1') ? 'is-invalid' : '' }}" type="text" name="n_1" id="n_1" value="{{ old('n_1', '') }}">
                @if($errors->has('n_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('f_1') ? 'is-invalid' : '' }}" type="text" name="f_1" id="f_1" value="{{ old('f_1', '') }}">
                @if($errors->has('f_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('t_2') ? 'is-invalid' : '' }}" type="text" name="t_2" id="t_2" value="{{ old('t_2', '') }}">
                @if($errors->has('t_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('n_2') ? 'is-invalid' : '' }}" type="text" name="n_2" id="n_2" value="{{ old('n_2', '') }}">
                @if($errors->has('n_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('f_2') ? 'is-invalid' : '' }}" type="text" name="f_2" id="f_2" value="{{ old('f_2', '') }}">
                @if($errors->has('f_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('t_3') ? 'is-invalid' : '' }}" type="text" name="t_3" id="t_3" value="{{ old('t_3', '') }}">
                @if($errors->has('t_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('n_3') ? 'is-invalid' : '' }}" type="text" name="n_3" id="n_3" value="{{ old('n_3', '') }}">
                @if($errors->has('n_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('f_3') ? 'is-invalid' : '' }}" type="text" name="f_3" id="f_3" value="{{ old('f_3', '') }}">
                @if($errors->has('f_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('t_4') ? 'is-invalid' : '' }}" type="text" name="t_4" id="t_4" value="{{ old('t_4', '') }}">
                @if($errors->has('t_4'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('n_4') ? 'is-invalid' : '' }}" type="text" name="n_4" id="n_4" value="{{ old('n_4', '') }}">
                @if($errors->has('n_4'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('f_4') ? 'is-invalid' : '' }}" type="text" name="f_4" id="f_4" value="{{ old('f_4', '') }}">
                @if($errors->has('f_4'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('r_1') ? 'is-invalid' : '' }}" type="text" name="r_1" id="r_1" value="{{ old('r_1', '') }}">
                @if($errors->has('r_1'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('r_2') ? 'is-invalid' : '' }}" type="text" name="r_2" id="r_2" value="{{ old('r_2', '') }}">
                @if($errors->has('r_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('r_3') ? 'is-invalid' : '' }}" type="text" name="r_3" id="r_3" value="{{ old('r_3', '') }}">
                @if($errors->has('r_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('r_4') ? 'is-invalid' : '' }}" type="text" name="r_4" id="r_4" value="{{ old('r_4', '') }}">
                @if($errors->has('r_4'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tr') ? 'is-invalid' : '' }}" type="text" name="tr" id="tr" value="{{ old('tr', '') }}">
                @if($errors->has('tr'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tr_nota') ? 'is-invalid' : '' }}" type="text" name="tr_nota" id="tr_nota" value="{{ old('tr_nota', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('t_falta') ? 'is-invalid' : '' }}" type="text" name="t_falta" id="t_falta" value="{{ old('t_falta', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('recuperacao') ? 'is-invalid' : '' }}" type="text" name="recuperacao" id="recuperacao" value="{{ old('recuperacao', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('aluno_nome') ? 'is-invalid' : '' }}" type="text" name="aluno_nome" id="aluno_nome" value="{{ old('aluno_nome', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('materia_nome') ? 'is-invalid' : '' }}" type="text" name="materia_nome" id="materia_nome" value="{{ old('materia_nome', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('abreviado_nome') ? 'is-invalid' : '' }}" type="text" name="abreviado_nome" id="abreviado_nome" value="{{ old('abreviado_nome', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('professor_nome') ? 'is-invalid' : '' }}" type="text" name="professor_nome" id="professor_nome" value="{{ old('professor_nome', '') }}">
