    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.emails.update", [$email->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nome') ? 'is-invalid' : '' }}" type="text" name="nome" id="nome" value="{{ old('nome', $email->nome) }}">
                @if($errors->has('nome'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('texto') ? 'is-invalid' : '' }}" name="texto" id="texto">{{ old('texto', $email->texto) }}</textarea>
                @if($errors->has('texto'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('inicio') ? 'is-invalid' : '' }}" type="text" name="inicio" id="inicio" value="{{ old('inicio', $email->inicio) }}">
