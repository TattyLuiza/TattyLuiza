...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.planosAula.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.planos-aulas.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bimestre') ? 'is-invalid' : '' }}" type="text" name="bimestre" id="bimestre" value="{{ old('bimestre', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('carga_horaria') ? 'is-invalid' : '' }}" type="text" name="carga_horaria" id="carga_horaria" value="{{ old('carga_horaria', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('apostila') ? 'is-invalid' : '' }}" type="text" name="apostila" id="apostila" value="{{ old('apostila', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('capitulo') ? 'is-invalid' : '' }}" type="text" name="capitulo" id="capitulo" value="{{ old('capitulo', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('habilidades') ? 'is-invalid' : '' }}" name="habilidades" id="habilidades">{!! old('habilidades') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('metodologia') ? 'is-invalid' : '' }}" name="metodologia" id="metodologia">{!! old('metodologia') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('avaliacao') ? 'is-invalid' : '' }}" name="avaliacao" id="avaliacao">{!! old('avaliacao') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('link') ? 'is-invalid' : '' }}" name="link" id="link">{!! old('link') !!}</textarea>
                @if($errors->has('link'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('recurso') ? 'is-invalid' : '' }}" name="recurso" id="recurso">{{ old('recurso') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('atividade') ? 'is-invalid' : '' }}" name="atividade" id="atividade">{{ old('atividade') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('leitura') ? 'is-invalid' : '' }}" name="leitura" id="leitura">{{ old('leitura') }}</textarea>
