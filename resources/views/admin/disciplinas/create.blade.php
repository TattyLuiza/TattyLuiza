...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.disciplina.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.disciplinas.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('abreviado') ? 'is-invalid' : '' }}" type="text" name="abreviado" id="abreviado" value="{{ old('abreviado', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('ementa') ? 'is-invalid' : '' }}" name="ementa" id="ementa">{!! old('ementa') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('livros') ? 'is-invalid' : '' }}" type="text" name="livros" id="livros" value="{{ old('livros', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ordem') ? 'is-invalid' : '' }}" type="number" name="ordem" id="ordem" value="{{ old('ordem', '') }}" step="1">
                @if($errors->has('ordem'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tipo_2') ? 'is-invalid' : '' }}" type="number" name="tipo_2" id="tipo_2" value="{{ old('tipo_2', '') }}" step="1">
