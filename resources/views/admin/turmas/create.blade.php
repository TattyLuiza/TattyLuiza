...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.turma.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.turmas.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('letivos') ? 'is-invalid' : '' }}" type="number" name="letivos" id="letivos" value="{{ old('letivos', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('carga_horaria') ? 'is-invalid' : '' }}" type="number" name="carga_horaria" id="carga_horaria" value="{{ old('carga_horaria', '') }}" step="1" required>
