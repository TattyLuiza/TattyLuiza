...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.seriess.update", [$series->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="tipo">{{ trans('cruds.series.fields.tipo') }}</label>
                <input class="form-control {{ $errors->has('tipo') ? 'is-invalid' : '' }}" type="text" name="tipo" id="tipo" value="{{ old('tipo', $series->tipo) }}">
                @if($errors->has('tipo'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nome') ? 'is-invalid' : '' }}" type="text" name="nome" id="nome" value="{{ old('nome', $series->nome) }}" required>
                @if($errors->has('nome'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('turno') ? 'is-invalid' : '' }}" type="text" name="turno" id="turno" value="{{ old('turno', $series->turno) }}">
                @if($errors->has('turno'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('valor') ? 'is-invalid' : '' }}" type="number" name="valor" id="valor" value="{{ old('valor', $series->valor) }}" step="0.01">
                @if($errors->has('valor'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sala') ? 'is-invalid' : '' }}" type="text" name="sala" id="sala" value="{{ old('sala', $series->sala) }}">
                @if($errors->has('sala'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('obs') ? 'is-invalid' : '' }}" name="obs" id="obs">{{ old('obs', $series->obs) }}</textarea>
                @if($errors->has('obs'))
