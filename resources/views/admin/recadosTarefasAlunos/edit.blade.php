...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.recadosTarefasAluno.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.recados-tarefas-alunos.update", [$recadosTarefasAluno->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('id_recado_tarefa_professor') ? 'is-invalid' : '' }}" name="id_recado_tarefa_professor_id" id="id_recado_tarefa_professor_id">
                    @foreach($id_recado_tarefa_professors as $id => $entry)
                        <option value="{{ $id }}" {{ (old('id_recado_tarefa_professor_id') ? old('id_recado_tarefa_professor_id') : $recadosTarefasAluno->id_recado_tarefa_professor->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('id_professor') ? 'is-invalid' : '' }}" name="id_professor_id" id="id_professor_id" required>
                    @foreach($id_professors as $id => $entry)
                        <option value="{{ $id }}" {{ (old('id_professor_id') ? old('id_professor_id') : $recadosTarefasAluno->id_professor->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('id_alunos') ? 'is-invalid' : '' }}" name="id_alunos[]" id="id_alunos" multiple>
                    @foreach($id_alunos as $id => $id_aluno)
                        <option value="{{ $id }}" {{ (in_array($id, old('id_alunos', [])) || $recadosTarefasAluno->id_alunos->contains($id)) ? 'selected' : '' }}>{{ $id_aluno }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('titulo') ? 'is-invalid' : '' }}" type="text" name="titulo" id="titulo" value="{{ old('titulo', $recadosTarefasAluno->titulo) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('texto') ? 'is-invalid' : '' }}" name="texto" id="texto">{!! old('texto', $recadosTarefasAluno->texto) !!}</textarea>
                @if($errors->has('texto'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('arquivo') ? 'is-invalid' : '' }}" name="arquivo" id="arquivo">{{ old('arquivo', $recadosTarefasAluno->arquivo) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tipo') ? 'is-invalid' : '' }}" type="text" name="tipo" id="tipo" value="{{ old('tipo', $recadosTarefasAluno->tipo) }}" required>
                @if($errors->has('tipo'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('modo') ? 'is-invalid' : '' }}" type="text" name="modo" id="modo" value="{{ old('modo', $recadosTarefasAluno->modo) }}" required>
                @if($errors->has('modo'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('leu') ? 'is-invalid' : '' }}" type="number" name="leu" id="leu" value="{{ old('leu', $recadosTarefasAluno->leu) }}" step="1" required>
                @if($errors->has('leu'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('agendamento') ? 'is-invalid' : '' }}" type="text" name="agendamento" id="agendamento" value="{{ old('agendamento', $recadosTarefasAluno->agendamento) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('lida_at') ? 'is-invalid' : '' }}" type="text" name="lida_at" id="lida_at" value="{{ old('lida_at', $recadosTarefasAluno->lida_at) }}">
