...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.responsavei.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.responsaveis.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('instrucao') ? 'is-invalid' : '' }}" type="text" name="instrucao" id="instrucao" value="{{ old('instrucao', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('profissao') ? 'is-invalid' : '' }}" type="text" name="profissao" id="profissao" value="{{ old('profissao', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('trabalho') ? 'is-invalid' : '' }}" type="text" name="trabalho" id="trabalho" value="{{ old('trabalho', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fonetrabalho') ? 'is-invalid' : '' }}" type="text" name="fonetrabalho" id="fonetrabalho" value="{{ old('fonetrabalho', '') }}">
