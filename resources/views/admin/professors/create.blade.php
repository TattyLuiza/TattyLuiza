...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.professor.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.professors.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pis') ? 'is-invalid' : '' }}" type="text" name="pis" id="pis" value="{{ old('pis', '') }}">
                @if($errors->has('pis'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ctps') ? 'is-invalid' : '' }}" type="text" name="ctps" id="ctps" value="{{ old('ctps', '') }}">
                @if($errors->has('ctps'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('admissao') ? 'is-invalid' : '' }}" type="text" name="admissao" id="admissao" value="{{ old('admissao') }}" required>
